package com.example.opencvtesting.ui.documentScanner.image_contour_selector;
...
public class ImageContourSelectorViewModel extends ViewModel {
    ...
    public void notifyChangesToParentFragment(NavController navController, int flag)
    {
        ...
        if(backStackEntry != null) {
            ...
            savedStateHandle.set(TAG_EDITED_BITMAP, ImageProcessing.warpPerspective(mBitmap.getValue(), new MatOfPoint2f(mContour.getValue())));
